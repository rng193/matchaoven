  ...
  return (
    <section id="about" className="py-28 bg-cream-50">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <h2 className="font-serif text-4xl md:text-5xl font-semibold text-matcha-900 mb-8 leading-tight">
          Baked with Passion, Steeped in Tradition
        </h2>
        <p className="text-matcha-700 text-base leading-relaxed mb-5 font-light">
        ...
        <p className="text-matcha-700 text-base leading-relaxed mb-12 font-light">
        ...
        <div className="grid grid-cols-3 gap-6 border-t border-cream-200 pt-8">
          {[
            ...
            <div key={label}>
              <div className="font-serif text-2xl font-semibold text-matcha-800">{number}</div>
              <div className="text-xs text-matcha-500 mt-1 uppercase tracking-wide">{label}</div>
            </div>
          ))}
        </div>
      </div>
